...
public class DomainResourceTestMatchers2 {
    ...
    public static Matcher<? super ResponseEntity> isForbidden() {
        return new ResultActionsMatcher("forbidden", response -> {
    ...
    public static Matcher<? super ResponseEntity> isNoContent() {
        return new ResultActionsMatcher("no content", request -> {
    ...
    public static Matcher<? super ResponseEntity> isMethodNotAllowed() {
        return new ResultActionsMatcher("method not allowed", response -> {
